    ...
    <section className="section   min-h-full ">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mt-16">
        {displayedCategories.map((category, index) => (
          <div
            key={index}
            // className="min-w-[220px] flex-shrink-0 flex flex-col items-center justify-center p-6 bg-card-bg rounded-xs shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-border-300"
            className="flex flex-col items-center justify-center p-6 bg-300 rounded-xs shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-border-300"
          >
