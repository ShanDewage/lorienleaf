...
function Newsletter() {
  return (
    <>
      <div className="bg-secondary relative overflow-x-hidden min-h-80 flex flex-col items-center justify-center px-6 ">
        <Image
        ...
        <div className=" mx-auto text-center flex flex-col items-center justify-center ">
          <h2 className="text-3xl font-bold h2 mb-4 relative inline-flex items-center font-serif">
