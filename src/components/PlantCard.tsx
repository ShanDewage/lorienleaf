  ...
  return (
    <div className="relative  text-center max-w-xs w-full border border-gray-200 ">
      ...
      <Image
        src={image}
        alt={alt}
        className="mx-auto object-contain bg-card-foreground w-full max-w-[300px] pt-8"
        width={300}
        height={300}
        loading="lazy"
      />
      ...
      <div className="py-6 px-6 text-gray-500 text-sm">
        {/* Name */}
        <p className="font-heading pb-2  tracking-wide group-hover:text-gray-900 dark:group-hover:text-white transition-all">
          {name}
        </p>
